...
def dijet_hists(events, params, analyzer):
    ...
    analyzer.H(
        f'dijet_v_fatjet1_mass_softdrop',
        [makeAxis(100, 0, 2500, "$m_{jj}$", unit="GeV"),
         makeAxis(100, 0, 2500, "$m_{j1,SD}$", unit="GeV")],
        [dijet.mass, 
         fatjet_1.msoftdrop],
        description="Softdrop Mass of Dijet vs Mass of FatJet1",
    )

    analyzer.H(
        f'dijet_v_fatjet1_mass_softdrop_ratio',
        [makeAxis(100, 0, 2500, "$m_{jj}$", unit="GeV"),
         makeAxis(100, 0, 1, "$m_{j1,SD}/m_{jj}$", unit="GeV")],
        [dijet.mass, 
         fatjet_1.msoftdrop/dijet.mass],
